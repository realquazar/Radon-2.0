...
class DeleteModal(Modal):
    ...
    async def callback(self, interaction: nextcord.Interaction):
        ...
        idx = int(val) - 1
        # This calls the function inside FlexCog
...
class FlexPaginationView(View):
    ...
    # --- REMOVED GLOBAL interaction_check ---
    # We removed the global check so that the arrows work for everyone!
    ...
    async def back(self, btn, req):
        # NO CHECK HERE: Anyone can turn the page
